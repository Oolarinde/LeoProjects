...
_write = Depends(require_permission(Module.TENANTS, AccessLevel.WRITE))
...
def create_lease(
    ...
    db.flush()
    db.commit()
    db.refresh(lease, ["tenant", "location", "unit"])
...
def tenant_summary(
    ...
    active_leases_result = db.execute(
