...
def list_allowance_types(
    ...
    return types_service.list_allowance_types(db, current_user.company_id)
...
def create_allowance_type(
    ...
    return types_service.create_allowance_type(
...
def update_allowance_type(
    ...
    return types_service.update_allowance_type(
...
def delete_allowance_type(
    item_id: UUID,
    current_user: User = Depends(_write),
    db: Session = Depends(get_db),
):
    types_service.delete_allowance_type(db, item_id, current_user.company_id)
...
def list_deduction_types(
    ...
    return types_service.list_deduction_types(db, current_user.company_id)
...
def create_deduction_type(
    ...
    return types_service.create_deduction_type(
        db, current_user.company_id, data.model_dump()
    )
...
def update_deduction_type(
    ...
    return types_service.update_deduction_type(
        db, item_id, current_user.company_id, data.model_dump(exclude_unset=True)
    )
...
def delete_deduction_type(
    ...
    types_service.delete_deduction_type(db, item_id, current_user.company_id)
...
def list_tax_brackets(
    ...
    return types_service.list_tax_brackets(db, current_user.company_id)


@router.put("/tax-brackets", response_model=list[TaxBracketResponse])
def replace_tax_brackets(
    data: TaxBracketsReplace,
    current_user: User = Depends(_write),
    db: Session = Depends(get_db),
):
    return types_service.replace_tax_brackets(
...
def list_leave_policies(
    ...
    return types_service.list_leave_policies(db, current_user.company_id)
...
def create_leave_policy(
    ...
    return types_service.create_leave_policy(
        db, current_user.company_id, data.model_dump()
    )
...
def update_leave_policy(
    ...
    return types_service.update_leave_policy(
        db, item_id, current_user.company_id, data.model_dump(exclude_unset=True)
    )
...
def delete_leave_policy(
    ...
    types_service.delete_leave_policy(db, item_id, current_user.company_id)
